...
def rapport():
    ...
    requete = """INSERT INTO atb(type,date,sujet,description,log_mesg,recommandation) VALUES(%s, %s, %s, %s, %s, %s)"""
    recordTuple = (type, date, sujet, description, logmesg, recommandation)
